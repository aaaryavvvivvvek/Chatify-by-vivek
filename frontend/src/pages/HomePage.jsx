...
const HomePage=()=>{
    ...
    const {mutate:sendRequestMutation,isPending}=useMutation({
       ...
       useEffect(()=>{
        ...
        console.log("Outgoing friend requests:", outgoingFriendReqs);
        if (outgoingFriendReqs && outgoingFriendReqs.length > 0) {
            outgoingFriendReqs.forEach((req)=>{
                if (req?.recipient?._id) {
                  outgoingIds.add(req.recipient._id);
                  console.log("Added to outgoing IDs:", req.recipient._id);
                }
            });
        }
        console.log("Final outgoing IDs set:", outgoingIds);
    ...
    <div className= "p-4 sm:p-6 lg:p-8">
        <div className ="container mx-auto space-y-10">
            <div className ="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <h2 className="flex-2xl sm:text-3xl font-bold tracking-tight"> Your Friends</h2>
